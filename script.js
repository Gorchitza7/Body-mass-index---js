...
const weightPiter = 72
const heightPiter = 1.88
const weightDenis = 82
const heightDenis = 1.73

 // переменная = переменная с кг / переменная рост ** 2
 // во второй степени

const bmiPiter = weightPiter / heightPiter ** 2
const bmiDenis = weightDenis / heightDenis ** 2

const result = bmiDenis <= bmiPiter
